  ...
  return (
    <div className="hero__container font-recoleta">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8 flex">
        ...
        >
          <div
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#8e80ff] to-[#9089fc] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
        ...
        <div className="mx-auto max-w-2xl py-32 sm:pt-48 lg:pt-56">
          <div className="text-center ">
            ...
            <p className="mt-6 text-lg leading-8 text-[#000] font-[500]">
              {" "}
              ¡Hola! Soy{" "}
              <span className="subrrayado font-[700]">Luana Przygrodzki</span>.
              Una
              <span className="font-[700] subrrayado">
                {" "}
                Desarrolladora Frontend{" "}
              </span>
              desde hace 2 años y{" "}
              <span className="diseñadora font-[700] subrrayado">
                Diseñadora Gráfica{" "}
              </span>
              desde 2013.
            </p>
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <div className="flex justify-center">
                <a
                  href="https://github.com/Chrenovadg"
                  target="_blank"
